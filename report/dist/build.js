...
Component.options.__file = "/Users/ueki/workspace/reg-cli/report/src/App.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-62050c9e", Component.options)
  } else {
    hotAPI.reload("data-v-62050c9e", Component.options)
  }
...
function onAfterLeave(vnodeData, cb) {
  if (!cb) return vnodeData;

  var hooks = vnodeData.on || {};
  var prev = hooks.afterLeave;

  if (prev) {
    hooks.afterLeave = function (el) {
      prev(el);
...
var Backdrop = {
  ...
  render: function render(h, _ref) {
    ...
    var transitionData = onAfterLeave({ props: backdropTransition }, listeners.leave);

    return h('transition', transitionData, [show && h('div', { staticClass: 'modal-backdrop' })]);
  }
};
...
var ModalContent = {
  ...
  render: function render(h, _ref) {
    ...
    var child = ensureOnlyChild(children);

    if (child) {
      addStaticClass(child.data, 'modal-content');
    }

    var transitionData = onAfterLeave({ props: contentTransition }, listeners.leave);
...
var ModalPortal = {
  ...
  methods: {
    update: function update(name, current, props, children) {
  ...
  render: function render(h) {
    ...
    var modal = this._modals[this._current];
    ...
    if (modal) {
      ...
      var onAfterLeave$$1 = wait(numTransition, function () {
        removeDocumentClass(openClassBody);
      });

      return createModalVNode(h, { on: { leave: onAfterLeave$$1 } }, []);
    }
  }
};

function createModalVNode(h, data, children) {
  return h('div', { staticClass: 'modal-wrapper' }, [h(Backdrop, data), h(ModalContent, data, children)]);
}

function generateModal(Vue, mediator) {
  var portal = void 0;
  ...
  return {
    ...
    beforeCreate: function beforeCreate() {
      if (!portal) {
        portal = new Vue(ModalPortal).$mount().$on('close', function () {
          return mediator.pop();
        });
      }
    },
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(15), __webpack_require__(26)))
...
function searchItems(type) {
  ...
  return window['__reg__'][type].filter(function (item) {
    var words = _this.search.split(' ');
    return words.every(function (w) {
      return item.raw.indexOf(w) !== -1;
    });
  });
}
...
module.exports = {
  ...
  computed: {
    ...
    passedItems: function passedItems() {
      return searchItems.bind(this)('passedItems');
    },
    newItems: function newItems() {
      return searchItems.bind(this)('newItems');
    },
    deletedItems: function deletedItems() {
      return searchItems.bind(this)('deletedItems');
    },
    isNotFound: function isNotFound() {
      return this.failedItems.length === 0 && this.passedItems.length === 0 && this.newItems.length === 0 && this.deletedItems.length === 0;
    }
  },
  methods: {
    open: function open(src, bg) {
      this.modalSrc = src;
      this.modalBgSrc = bg;
...
var _vueLazyload = __webpack_require__(3);

var _vueLazyload2 = _interopRequireDefault(_vueLazyload);

var _vueThinModal = __webpack_require__(5);

var _vueThinModal2 = _interopRequireDefault(_vueThinModal);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var App = __webpack_require__(4);

_vue2.default.use(_vueThinModal2.default);
...
// module
exports.push([module.i, "\nimg[data-v-3167ba54] {\n  max-width: 100%;\n  border: solid 1px #f0f0f0;\n  border-radius: 2px;\n  pointer-events: auto;\n}\n.image>div[data-v-3167ba54] {\n  position: relative;\n}\n.bg[data-v-3167ba54] {\n  position: absolute;\n  opacity: 0.2;\n  pointer-events: none;\n}\n.header[data-v-3167ba54] {\n  margin-bottom: 5px !important;\n  font-weight: normal;\n}\n.label[data-v-3167ba54] {\n  border-radius: 2px 2px 0 0 !important;\n  margin: 0 0 0 2px !important;\n  padding: 5px 10px;\n}\n", ""]);
...
Component.options.__file = "/Users/ueki/workspace/reg-cli/report/src/views/CaptureImage.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] CaptureImage.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3167ba54", Component.options)
  } else {
    hotAPI.reload("data-v-3167ba54", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
Component.options.__file = "/Users/ueki/workspace/reg-cli/report/src/views/CaptureModal.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] CaptureModal.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c60f09b0", Component.options)
  } else {
    hotAPI.reload("data-v-c60f09b0", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "ui label mini"
  }, [_vm._v(_vm._s(_vm.kind))]), _vm._v(" "), _c('div', [(_vm.bg) ? _c('div', {
    staticClass: "bg"
  }, [_c('img', {
    attrs: {
      "src": _vm.bg
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-3167ba54", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "logo"
  }, [_vm._v("REG")]), _vm._v(" "), _c('div', [_vm._m(0), _vm._v(" "), _c('div', {
    staticClass: "ui input mini icon"
  }, [_c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    staticClass: "content"
  }, [(_vm.isNotFound) ? _c('div', {
    staticClass: "not-found"
  }, [_c('div', [_vm._v("\n        Items not found\n      ")])]) : _vm._e(), _vm._v(" "), (_vm.failedItems.length) ? _c('h3', {
    staticClass: "ui header items-header red"
  }, [_vm._v("\n      Changed items\n      "), _c('span', {
    ...
    }), _vm._v(_vm._s(item.raw) + "\n      ")])
  })) : _vm._e(), _vm._v(" "), _vm._l((_vm.failedItems), function(item) {
    return _c('div', {
      staticClass: "items"
    }, [_c('a', {
      staticClass: "ui link red",
      ...
      staticClass: "captures"
    }, [_c('div', {
      staticClass: "capture",
      on: {
        "click": function($event) {
          _vm.open(_vm.diffDir + item.raw, _vm.actualDir + item.raw)
        }
      }
    }, [_c('capture-image', {
      attrs: {
        "src": _vm.diffDir + item.raw,
        "bg": _vm.actualDir + item.raw,
        "kind": 'Diff'
      }
    })], 1), _vm._v(" "), _c('div', {
      staticClass: "capture",
      on: {
        "click": function($event) {
          _vm.open(_vm.actualDir + item.raw)
        }
      }
    }, [_c('capture-image', {
      attrs: {
        "src": _vm.actualDir + item.raw,
        "kind": 'After'
      }
    })], 1), _vm._v(" "), _c('div', {
      staticClass: "capture",
      on: {
        "click": function($event) {
          _vm.open(_vm.expectedDir + item.raw)
        }
      }
    }, [_c('capture-image', {
      attrs: {
        "src": _vm.expectedDir + item.raw,
        "kind": 'Before'
      }
    })], 1)])])
  ...
  })) : _vm._e(), _vm._v(" "), _vm._l((_vm.passedItems), function(item) {
    return _c('div', {
      staticClass: "items"
    }, [_c('a', {
      staticClass: "ui link green",
  ...
  })) : _vm._e(), _vm._v(" "), _vm._l((_vm.newItems), function(item) {
    return _c('div', {
      staticClass: "items"
    }, [_c('a', {
      staticClass: "ui link grey",
  ...
  })) : _vm._e(), _vm._v(" "), _vm._l((_vm.deletedItems), function(item) {
    return _c('div', {
      staticClass: "items"
    }, [_c('a', {
      staticClass: "ui link grey",
  ...
  return _c('a', {
    attrs: {
      "href": "https://github.com/bokuweb/reg-cli"
    }
  }, [_c('i', {
    staticClass: "ui icon github big"
  })])
}]}
module.exports.render._withStripped = true
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-62050c9e", module.exports)
  }
}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-c60f09b0", module.exports)
  }
}
...
var update = __webpack_require__(1)("90f0e99a", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3167ba54\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CaptureImage.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-3167ba54\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CaptureImage.vue");
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("35cc74d2", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-62050c9e\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue", function() {
     var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-62050c9e\",\"scoped\":true,\"hasInlineConfig\":false}!../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./App.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("40ece878", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c60f09b0\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./CaptureModal.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c60f09b0\",\"scoped\":false,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=1!./CaptureModal.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("a2951ab8", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c60f09b0\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CaptureModal.vue", function() {
     var newContent = require("!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c60f09b0\",\"scoped\":true,\"hasInlineConfig\":false}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./CaptureModal.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
